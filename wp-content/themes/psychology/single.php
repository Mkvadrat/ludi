...
<?php
									foreach($posts as $post_list){
										if($post_list->ID == get_the_ID()){
?>
											<li><a class="active-blog" href="<?php echo get_permalink($post_list->ID); ?>"><?php echo wp_trim_words( $post_list->post_title, 4,''); ?></a></li>
<?php
										}else{
?>
											<li><a href="<?php echo get_permalink($post_list->ID); ?>"><?php echo wp_trim_words( $post_list->post_title, 4,''); ?></a></li>
<?php
										}
									}
?>
